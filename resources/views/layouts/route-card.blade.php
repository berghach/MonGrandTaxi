@foreach ($routes as $item)
    ...
    <div class=" flex flex-wrap w-full -z-10 bg-cyan-300 p-3 rounded-xl items-center shadow-xl">
        ...
        <div class="flex flex-col grow gap-3">
            ...
            <a href="#" class="font-semibold text-black flex justify-center h-10 rounded-lg hover:bg-yellow-200 bg-primary p-2 transition ease-in-out duration-150">Delete</a>
        </div>
    </div>
    <!-- /route card -->
@endforeach